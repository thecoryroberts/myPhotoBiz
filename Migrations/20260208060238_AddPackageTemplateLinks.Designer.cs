...
namespace myPhotoBiz.Migrations
{
    ...
    [Migration("20260208060238_AddPackageTemplateLinks")]
    partial class AddPackageTemplateLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ContractVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("IsSystemVariable")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ContractVariableValue", b =>
                {
                    ...
                    b.Property<int>("ContractVariableId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ContractVariableId");

                    b.HasIndex("ContractId", "ContractVariableId")
                        .IsUnique()
                        .HasDatabaseName("IX_ContractVariableValue_Contract_Variable");

                    b.ToTable("ContractVariableValues");
                });
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.Gallery", b =>
                {
                    ...
                    b.Property<float>("WatermarkOpacity")
                        .HasColumnType("REAL");
                    ...
                    b.Property<bool>("WatermarkTiled")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.QuestionnaireAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.QuestionnaireTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ServicePackageContractTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ServicePackageId", "ContractTemplateId")
                        .IsUnique()
                        .HasDatabaseName("IX_ServicePackageContractTemplate_Package_Template");

                    b.ToTable("ServicePackageContractTemplates");
                });

            modelBuilder.Entity("MyPhotoBiz.Models.ServicePackageQuestionnaireTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ServicePackageId", "QuestionnaireTemplateId")
                        .IsUnique()
                        .HasDatabaseName("IX_ServicePackageQuestionnaireTemplate_Package_Template");

                    b.ToTable("ServicePackageQuestionnaireTemplates");
                });
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.QuestionnaireAssignment", b =>
                {
                    b.HasOne("MyPhotoBiz.Models.ApplicationUser", "AssignedByUser")
                        .WithMany()
                        .HasForeignKey("AssignedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyPhotoBiz.Models.ApplicationUser", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyPhotoBiz.Models.QuestionnaireTemplate", "QuestionnaireTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ServicePackageContractTemplate", b =>
                {
                    b.HasOne("MyPhotoBiz.Models.ContractTemplate", "ContractTemplate")
                        .WithMany()
                    ...
                    b.HasOne("MyPhotoBiz.Models.ServicePackage", "ServicePackage")
                        .WithMany("ContractTemplateLinks")
                        .HasForeignKey("ServicePackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ServicePackageQuestionnaireTemplate", b =>
                {
                    ...
                    b.HasOne("MyPhotoBiz.Models.ServicePackage", "ServicePackage")
                        .WithMany("QuestionnaireTemplateLinks")
                        .HasForeignKey("ServicePackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.ServicePackage", b =>
                {
                    ...
                    b.Navigation("ContractTemplateLinks");

                    b.Navigation("Invoices");

                    b.Navigation("PhotoShoots");

                    b.Navigation("QuestionnaireTemplateLinks");
                });
