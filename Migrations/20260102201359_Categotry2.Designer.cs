...
namespace myPhotoBiz.Migrations
{
    ...
    [Migration("20260102201359_Categotry2")]
    partial class Categotry2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.BookingRequest", b =>
                {
                    ...
                    b.Property<int?>("ClientProfileId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyPhotoBiz.Models.BookingRequest", b =>
                {
                    ...
                    b.HasOne("MyPhotoBiz.Models.ClientProfile", null)
                        .WithMany("BookingRequests")
                        .HasForeignKey("ClientProfileId1");
